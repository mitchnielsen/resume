...
**Programming Languages and Tools**: Golang, Terraform, Operator SDK, Docker, Kubernetes, Helm, Istio, Ansible
...
### <span>GE Transportation, _Sr. Build and Release Engineer_</span> <span>August 2018 – April 2020</span>
 - Built a CI/CD deployment pipeline for 20+ microservices using Kubernetes, Kustomize, and GitLab CI, enabling consistent, fault-tolerant application environments for one of the largest development teams
 - Developed shared build, test, and release templates that ensured best practices and common toolsets across cloud-native application teams
 - Integrated Checkmarx, SonarQube, and AquaSec security analysis into shared pipelines for four major teams using Docker-based reusable pipeline stages
...
### <span>GE Transportation, _Digital Technology Leadership Program Member_</span> <span>July 2016 – July 2018</span>
 ...
 - _Rotation 1_: DevOps Engineer - Supported the build and release process for a commercial software development team by integrating and automating web security scanning
